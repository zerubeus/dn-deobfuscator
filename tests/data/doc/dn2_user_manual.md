...
5. Press and hold [RECORD], then press [PLAY] to enter LIVE RECORDING mode.
6. Turn a DATA ENTRY knob, or play the [TRIG] keys in KEYBOARD mode, to add parameter locks to
...
7. Press and hold [RECORD], then press [STOP] to enter STEP RECORDING mode.
8. Press and hold a [TRIG] key, and then turn the DATA ENTRY knobs that control the parameter you
